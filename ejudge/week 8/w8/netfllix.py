...
def func_pre(numsame, numload):
    ...
    if ans1 > 0:
        ans += 1
    print("Premium x %d"%ans)
    print("Total =", ans*419, "THB")
...
def func_std(numsame, numload):
    ...
    if max(numsame, numload) > 2:
        ...
        howmuch = ans*419
        rnd += 1
    if howmany > 0 or rnd == 0:
        if rnd == 0:
            ans = max(numsame, numload)//2
            print("Standard x %d"%ans)
            print("Total =", ans*349, "THB")
        else:
            ans = howmany//2
            ans1 = howmany%2
            if ans1 > 0:
...
def func_bsc(numsame, numload):
    ...
    if max(numsame, numload) > 2:
        ...
        howmuch = ans*419
        rnd = 1
    if howmany > 1 or (max(numsame, numload) > 1 and rnd == 0):
        if rnd == 0:
            ans = max(numsame, numload)//2
            print("Standard x %d"%ans)
            print("Total =", ans*349, "THB")
    ...
    if howmany > 0 or rnd == 0:
        if rnd == 0:
            ...
            print("Basic x %d"%ans)
            print("Total =", ans*279, "THB")
        else:
            print("Basic x %d"%howmany)
...
def func_mb(numsame, numload):
    '''mobile'''
    ans = max(numsame, numload)
    print("Mobile x %d"%ans)
    print("Total =", ans*99, "THB")
